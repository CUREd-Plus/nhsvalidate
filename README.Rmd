...
**NB** - You need an account to access the following data sets and typically have to request access to individual
schemas.

+ **Hospital Episode Statistics (HES)** [Commissioning Data Set XML
  Schema - TRUD](https://isd.digital.nhs.uk/trud/users/authenticated/filters/0/categories/1/items/245/releases)
+ **Emergency Care Data Set (ECDS)** [Emergency Care Data Set XML Schema -
  TRUD](https://isd.digital.nhs.uk/trud/users/authenticated/filters/0/categories/1/items/1819/releases)
+ **Mental Health Services Data Set (MHSDS)** [Mental Health Services Data Set Commissioner extract XML Schemas -
  TRUD](https://isd.digital.nhs.uk/trud/users/authenticated/filters/0/categories/1/items/1779/releases)
...
+ [dataverifyr](https://davzim.github.io/dataverifyr/)

## Reference

+ [xml2 Examples by Konrad M. Lawson](https://kmlawson.github.io/dh-tutorials/xml2examples.html)
...
+ [XPath online real-time tester](http://xpather.com/) - invaluable for building expressions in real-time!
+ [XML to DataFrame solution](https://stackoverflow.com/questions/48476663/extract-text-from-xml-but-file-has-duplicated-node-names)
